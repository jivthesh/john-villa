...
//                 <h1 className="text-4xl md:text-5xl font-bold text-white">Python Lists</h1>
//                 <p className="text-sky-400 mt-2">The Complete Guide</p>
//             </header>
...
// export default PythonListsLesson;
