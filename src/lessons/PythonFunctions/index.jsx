// FILE: src/lessons/PythonFunctions/index.jsx
    ...
    return (
        <div>
            <header className="text-center mb-8">
                <h1 className="text-4xl md:text-5xl font-bold text-white">Python Functions</h1>
                <p className="text-sky-400 mt-2">Building Blocks of Reusable Code</p>
            </header>
...
export default PythonFunctionsLesson;
