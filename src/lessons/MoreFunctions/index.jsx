    ...
    return (
        <div>
            <header className="text-center mb-8">
                <h1 className="text-4xl md:text-5xl font-bold text-white">More Coding Examples With Functions</h1>
                <p className="text-sky-400 mt-2">Practical Applications in Python</p>
            </header>
...
export default MoreFunctionsLesson;
