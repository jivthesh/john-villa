...
const PythonDictionariesLesson = () => {
    ...
    return (
        <div>
            <header className="text-center mb-8">
                <h1 className="text-4xl md:text-5xl font-bold text-white">Python Dictionaries</h1>
                <p className="text-sky-400 mt-2">The Ultimate Guide to Key-Value Pairs</p>
            </header>
...
export default PythonDictionariesLesson;
