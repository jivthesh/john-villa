    ...
    return (
        <div>
            <header className="text-center mb-8">
                <h1 className="text-4xl md:text-5xl font-bold text-white">Python Sets</h1>
                <p className="text-sky-400 mt-2">The Complete Guide to Unique Collections</p>
            </header>
...
export default PythonSetsLesson;
